...
PACKAGES="shadow zsh kira-zsh-plugins kira-branding kira-seat kira-login kira-net kira-session-bus make zlib flex bison pkgconf kira-basic-tools os-prober grub efivar efibootmgr nano sudo build-essential"
