...
PACKAGES="shadow shadow-login zsh kira-zsh-plugins kira-branding kira-seat kira-login kira-net kira-session-bus zlib flex bison pkgconf kira-basic-tools kira-build-essential os-prober grub grub-efi efivar efibootmgr nano sudo git"
